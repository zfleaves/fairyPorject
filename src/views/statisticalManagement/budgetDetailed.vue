  ...
  <div class="budgetDetailed">
      ...
      <el-form ref="searchForm" :model="searchForm" label-width="120px">
        <el-row :gutter="20">
          ...
          <el-col style="text-align:right;" :span="6">
            <el-button @click="generateReports" type="warning">生成报表</el-button>
            <el-button @click="handleMoreSearch" type="primary" plain>{{moreSearch? '收起条件':'更多条件'}}</el-button>
          </el-col>
        </el-row>
    ...
    <div class="budgetDetailedCon">
      ...
      >
        ...
        <el-table-column prop="projectManager" label="项目经理" v-if="checkFlag1" show-overflow-tooltip></el-table-column>
        <el-table-column prop="startDate" label="开工日期" v-if="checkFlag2" show-overflow-tooltip>
        ...
        <el-table-column prop="standard" label="规格" v-if="checkFlag4" show-overflow-tooltip></el-table-column>
        <el-table-column prop="unit" label="单位" v-if="checkFlag5" show-overflow-tooltip></el-table-column>
        <el-table-column label="投标预算">
          <el-table-column prop="budTotalNum" label="数量" width="60"></el-table-column>
          <el-table-column prop="budAmount" label="金额" width="60"></el-table-column>
        </el-table-column>
        <el-table-column label="施工预算">
          <el-table-column prop="demTotalNum" label="数量" width="60"></el-table-column>
          <el-table-column prop="demAmount" label="金额" width="60"></el-table-column>
        </el-table-column>
        <el-table-column label="需求计划">
          <el-table-column prop="applyTotalNum" label="数量" width="60"></el-table-column>
          <el-table-column prop="applyAmount" label="金额" width="60"></el-table-column>
        </el-table-column>
        <el-table-column label="合同">
          <el-table-column prop="signTotalNum" label="数量" width="60"></el-table-column>
          <el-table-column prop="signAmount" label="金额" width="60"></el-table-column>
        </el-table-column>
        <el-table-column label="订单">
          <el-table-column prop="orderTotalNum" label="数量" width="60"></el-table-column>
          <el-table-column prop="orderAmount" label="金额" width="60"></el-table-column>
        </el-table-column>
        <el-table-column label="结算">
          <el-table-column prop="settleTotalNum" label="数量" width="60"></el-table-column>
          <el-table-column prop="settleAmount" label="金额" width="60"></el-table-column>
        </el-table-column>
        <el-table-column label="库存">
          <el-table-column prop="stockTotalNum" label="数量" width="60"></el-table-column>
          <el-table-column prop="stockAmount" label="金额" width="60"></el-table-column>
        </el-table-column>
      </el-table>
    </div>
  </div>
  ...
  methods: {
    ...
    getSummaries(param) {
      ...
      columns.forEach((column, index) => {
        ...
        if (
          column.property === "budAmount" ||
          column.property === "stockAmount" ||
          column.property === "settleAmount" ||
          column.property === "orderAmount" ||
          column.property === "signAmount" ||
          column.property === "applyAmount" ||
