<template>
    <div class="projectMembers">
        ...
        <div class="memberInformation">
            <div class="myProjectTitle"><span class="title">项目成员信息</span><el-button size="small" @click="handleClickAdd" type="primary" icon="el-icon-plus">添加</el-button></div>
                                ...
                                <div class="right">
                                    <ul>
                                        <li v-for="threeChild in child.children" :key="threeChild.id">
                                            <el-checkbox :disabled="item.disabled" v-model="threeChild.checked">{{threeChild.resName}}</el-checkbox>
                                        </li>
        ...
        <el-dialog class="two" center title="项目成员选择岗位" height="80%" width="80%" :visible.sync="projectMembersVisible">
         ...
         <el-dialog class="three" center title="选择岗位" width="60%" v-if="selectRolesVisible" :visible.sync="selectRolesVisible">
             <el-table
                border
                ref="multipleTable"
        ...
        <el-dialog class="four" center title="选择项目成员" width="80%" v-if="selectProjectMembersVisible" :visible.sync="selectProjectMembersVisible">
                 ...
                 <div class="treeCon">
                     ...
                     :data="orgsList"  @node-click="handleNodeClick">
                          <span class="custom-tree-node" slot-scope="{node,data}">
                              <!-- <span>{{node}}</span> -->
                               <!-- <span>{{data}}</span> -->
                            <span class="data.orgAttribute === '01' ? '' : data.orgAttribute === '02' ? 'pad10' : 'pad20'">{{ data.orgName || data.departmentName }}<span>{{data.orgAttribute === '01' ? '(总公司)' : data.orgAttribute === '02' ? '(分公司)' : '(部门)'}}</span></span>
